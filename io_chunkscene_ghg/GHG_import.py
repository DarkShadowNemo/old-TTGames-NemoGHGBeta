...
def GHG_mesh(f, filepath):
            ...
            if flag2a == 0x6D:
                if vertexCount == 0:
                    ...
                    for i in range(vertexCount):
                        f.seek(-16,1)
                    for i in range(1):
                        vx1_4a = unpack("<H", f.read(2))[0]
                        vy1_4a = unpack("<H", f.read(2))[0]
                        vz1_4a = unpack("<H", f.read(2))[0]
                        nz_4a = unpack("<H", f.read(2))[0]
                        uvx1_4a = unpack("<H", f.read(2))[0]
                        uvy1_4a = unpack("<H", f.read(2))[0]
                        unk1_4a = unpack("<I", f.read(4))[0]
                        vx1_4b = unpack("<H", f.read(2))[0]
                        vy1_4b = unpack("<H", f.read(2))[0]
                        vz1_4b = unpack("<H", f.read(2))[0]
                        nz_4b = unpack("<H", f.read(2))[0]
                        uvx1_4b = unpack("<H", f.read(2))[0]
                        uvy1_4b = unpack("<H", f.read(2))[0]
                        unk1_4b = unpack("<I", f.read(4))[0]
                        vx1_4c = unpack("<H", f.read(2))[0]
                        vy1_4c = unpack("<H", f.read(2))[0]
                        vz1_4c = unpack("<H", f.read(2))[0]
                        nz_4c = unpack("<H", f.read(2))[0]
                        uvx1_4c = unpack("<H", f.read(2))[0]
                        uvy1_4c = unpack("<H", f.read(2))[0]
                        unk1_4c = unpack("<I", f.read(4))[0]
                        vx1_4d = unpack("<H", f.read(2))[0]
                        vy1_4d = unpack("<H", f.read(2))[0]
                        vz1_4d = unpack("<H", f.read(2))[0]
                        nz_4d = unpack("<H", f.read(2))[0]
                        uvx1_4d = unpack("<H", f.read(2))[0]
                        uvy1_4d = unpack("<H", f.read(2))[0]
                        unk1_4d = unpack("<I", f.read(4))[0]
                        vx1_4e = unpack("<H", f.read(2))[0]
                        vy1_4e = unpack("<H", f.read(2))[0]
                        vz1_4e = unpack("<H", f.read(2))[0]
                        nz_4e = unpack("<H", f.read(2))[0]
                        uvx1_4e = unpack("<H", f.read(2))[0]
                        uvy1_4e = unpack("<H", f.read(2))[0]
                        unk1_4e = unpack("<I", f.read(4))[0]
                        vx1_4f = unpack("<H", f.read(2))[0]
                        vy1_4f = unpack("<H", f.read(2))[0]
                        vz1_4f = unpack("<H", f.read(2))[0]
                        nz_4f = unpack("<H", f.read(2))[0]
                        uvx1_4f = unpack("<H", f.read(2))[0]
                        uvy1_4f = unpack("<H", f.read(2))[0]
                        unk1_4f = unpack("<I", f.read(4))[0]
                        vx1_4g = unpack("<H", f.read(2))[0]
                        vy1_4g = unpack("<H", f.read(2))[0]
                        vz1_4g = unpack("<H", f.read(2))[0]
                        nz_4g = unpack("<H", f.read(2))[0]
                        uvx1_4g = unpack("<H", f.read(2))[0]
                        uvy1_4g = unpack("<H", f.read(2))[0]
                        unk1_4g = unpack("<I", f.read(4))[0]
                    ...
                    if flagsC == 0x6E:
                        if facecount == 2:
                            ...
                            faces2d.append([fb1aaad,fc1aaad,fd1aaad])
                            faces2d.append([fc1aaad,fd1aaad,fe1aaad])
                            ...
                            fh1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            fi1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            fj1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            fk1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            fl1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            fm1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            fn1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            fo1aaadx = unpack("B", f.read(1))[0] & 0x1F
                            f.seek(4,1)
                            ...
                            fg1aaadx+=1*len(vertices2d)-7
                            fh1aaadx+=1*len(vertices2d)-7
                            fi1aaadx+=1*len(vertices2d)-7
                            fj1aaadx+=1*len(vertices2d)-7
                            fk1aaadx+=1*len(vertices2d)-7
                            fl1aaadx+=1*len(vertices2d)-7
                            fm1aaadx+=1*len(vertices2d)-7
                            fn1aaadx+=1*len(vertices2d)-7
                            fo1aaadx+=1*len(vertices2d)-7

                            if fa1aaadx == 0 and fb1aaadx == 1 and fc1aaadx == 2 and fd1aaadx == 1 and fe1aaadx == 2 and ff1aaadx == 3 and fg1aaadx == 2 and fh1aaadx == 3 and fi1aaadx == 4 and fj1aaadx == 3 and fk1aaadx == 4 and fl1aaadx == 5 and fm1aaadx == 4 and fn1aaadx == 5 and fo1aaadx == 6:
                                faces2d.append([fa1aaadx,fb1aaadx,fc1aaadx])
                                faces2d.append([fd1aaadx,fe1aaadx,ff1aaadx])
                                faces2d.append([fg1aaadx,fh1aaadx,fi1aaadx])
                                faces2d.append([fj1aaadx,fk1aaadx,fl1aaadx])
                                faces2d.append([fm1aaadx,fn1aaadx,fo1aaadx])
                            elif fa1aaadx != 0 and fb1aaadx != 1 and fc1aaadx != 2 and fd1aaadx != 1 and fe1aaadx != 2 and ff1aaadx != 3 and fg1aaadx != 2 and fh1aaadx != 3 and fi1aaadx != 4 and fj1aaadx != 3 and fk1aaadx != 4 and fl1aaadx != 5 and fm1aaadx != 4 and fn1aaadx != 5 and fo1aaadx != 6:
                                faces2d.append([fa1aaadx,fb1aaadx,fc1aaadx])
                                faces2d.append([fd1aaadx,fe1aaadx,ff1aaadx])
                                faces2d.append([fg1aaadx,fh1aaadx,fi1aaadx])
                                faces2d.append([fj1aaadx,fk1aaadx,fl1aaadx])
                    ...
                    for i in range(vertexCount):
                        vx1_11 = unpack("<h", f.read(2))[0] / 4096
                        vy1_11 = unpack("<h", f.read(2))[0] / 4096
                        vz1_11 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(2,1)
                        uvx1_11 = unpack("<h", f.read(2))[0] / 4096
                        uvy1_11 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(4,1)
                        vertices2l.append([vx1_11,vz1_11,vy1_11])
                    ...
                    if flagsC == 0x6E:
                        if facecount == 6:
                            ...
                            id1 = unpack("B", f.read(1))[0]
                            fa1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fb1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fc1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fd1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fe1aaal = unpack("B", f.read(1))[0] & 0x2F
                            ff1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fg1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fh1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fi1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fj1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fk1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fl1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fm1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fn1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fo1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fp1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fq1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fr1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fs1aaal = unpack("B", f.read(1))[0] & 0x2F
                            ft1aaal = unpack("B", f.read(1))[0] & 0x2F
                            fu1aaal = unpack("B", f.read(1))[0] & 0x2F
                            f.seek(2,1)
                            ...
                            fa1aaal+=1*len(vertices2l)-15
                            fb1aaal+=1*len(vertices2l)-15
                            fc1aaal+=1*len(vertices2l)-15
                            fd1aaal+=1*len(vertices2l)-15
                            fe1aaal+=1*len(vertices2l)-15
                            ff1aaal+=1*len(vertices2l)-15
                            fg1aaal+=1*len(vertices2l)-15
                            fh1aaal+=1*len(vertices2l)-15
                            fi1aaal+=1*len(vertices2l)-15
                            fj1aaal+=1*len(vertices2l)-15
                            fk1aaal+=1*len(vertices2l)-15
                            fl1aaal+=1*len(vertices2l)-15
                            fm1aaal+=1*len(vertices2l)-15
                            fn1aaal+=1*len(vertices2l)-15
                            fo1aaal+=1*len(vertices2l)-15
                            fp1aaal+=1*len(vertices2l)-15
                            fq1aaal+=1*len(vertices2l)-15
                            fr1aaal+=1*len(vertices2l)-15
                            fs1aaal+=1*len(vertices2l)-15
                            ft1aaal+=1*len(vertices2l)-15
                            fu1aaal+=1*len(vertices2l)-15

                            faces2l.append([fa1aaal,fb1aaal,fc1aaal])
                            faces2l.append([fb1aaal,fc1aaal,fd1aaal])
                            faces2l.append([fd1aaal,fe1aaal,ff1aaal])
                            faces2l.append([fg1aaal,fh1aaal,fi1aaal])
                            faces2l.append([fh1aaal,fi1aaal,fj1aaal])
                            faces2l.append([fi1aaal,fj1aaal,fk1aaal])
                            faces2l.append([fj1aaal,fk1aaal,fl1aaal])
                            faces2l.append([fk1aaal,fl1aaal,fm1aaal])
                            faces2l.append([fm1aaal,fn1aaal,fo1aaal])
                            faces2l.append([fn1aaal,fo1aaal,fp1aaal])
                            faces2l.append([fo1aaal,fp1aaal,fq1aaal])
                            faces2l.append([fp1aaal,fq1aaal,fr1aaal])
                            faces2l.append([fq1aaal,fr1aaal,fs1aaal])
                            faces2l.append([fr1aaal,fs1aaal,ft1aaal])
                            faces2l.append([fs1aaal,ft1aaal,fu1aaal])

                        elif facecount == 5:
                            
                            id1 = unpack("B", f.read(1))[0]
                            fa1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fb1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fc1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fd1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fe1aaala = unpack("B", f.read(1))[0] & 0x2F
                            ff1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fg1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fh1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fi1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fj1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fk1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fl1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fm1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fn1aaala = unpack("B", f.read(1))[0] & 0x2F
                            fo1aaala = unpack("B", f.read(1))[0] & 0x2F
                            f.seek(4,1)
                            ...
                            fa1aaala+=1*len(vertices2l)-15
                            fb1aaala+=1*len(vertices2l)-15
                            fc1aaala+=1*len(vertices2l)-15
                            fd1aaala+=1*len(vertices2l)-15
                            fe1aaala+=1*len(vertices2l)-15
                            ff1aaala+=1*len(vertices2l)-15
                            fg1aaala+=1*len(vertices2l)-15
                            fh1aaala+=1*len(vertices2l)-15
                            fi1aaala+=1*len(vertices2l)-15
                            fj1aaala+=1*len(vertices2l)-15
                            fk1aaala+=1*len(vertices2l)-15
                            fl1aaala+=1*len(vertices2l)-15
                            fm1aaala+=1*len(vertices2l)-15
                            fn1aaala+=1*len(vertices2l)-15
                            fo1aaala+=1*len(vertices2l)-15

                            faces2l.append([fa1aaala,fb1aaala,fc1aaala])
                            faces2l.append([fb1aaala,fc1aaala,fd1aaala])
                            faces2l.append([fd1aaala,fe1aaala,ff1aaala])
                            faces2l.append([fg1aaala,fh1aaala,fi1aaala])
                            faces2l.append([fh1aaala,fi1aaala,fj1aaala])
                            faces2l.append([fi1aaala,fj1aaala,fk1aaala])
                            faces2l.append([fj1aaala,fk1aaala,fl1aaala])
                            faces2l.append([fk1aaala,fl1aaala,fm1aaala])
                            faces2l.append([fm1aaala,fn1aaala,fo1aaala])

                        elif facecount == 4:
                            
                            id1 = unpack("B", f.read(1))[0]
                            fa1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fb1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fc1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fd1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fe1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            ff1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fg1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fh1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fi1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fj1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fk1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            fl1aaalb = unpack("B", f.read(1))[0] & 0x2F
                            f.seek(3,1)
                            ...
                            fa1aaalb+=1*len(vertices2l)-15
                            fb1aaalb+=1*len(vertices2l)-15
                            fc1aaalb+=1*len(vertices2l)-15
                            fd1aaalb+=1*len(vertices2l)-15
                            fe1aaalb+=1*len(vertices2l)-15
                            ff1aaalb+=1*len(vertices2l)-15
                            fg1aaalb+=1*len(vertices2l)-15
                            fh1aaalb+=1*len(vertices2l)-15
                            fi1aaalb+=1*len(vertices2l)-15
                            fj1aaalb+=1*len(vertices2l)-15
                            fk1aaalb+=1*len(vertices2l)-15
                            fl1aaalb+=1*len(vertices2l)-15

                            faces2l.append([fa1aaalb,fb1aaalb,fc1aaalb])
                            faces2l.append([fb1aaalb,fc1aaalb,fd1aaalb])
                            faces2l.append([fd1aaalb,fe1aaalb,ff1aaalb])
                            faces2l.append([fg1aaalb,fh1aaalb,fi1aaalb])
                            faces2l.append([fh1aaalb,fi1aaalb,fj1aaalb])
                            faces2l.append([fi1aaalb,fj1aaalb,fk1aaalb])
                            faces2l.append([fj1aaalb,fk1aaalb,fl1aaalb])

                elif vertexCount == 16:
                    for i in range(vertexCount):
                        vx1_12 = unpack("<h", f.read(2))[0] / 4096
                        vy1_12 = unpack("<h", f.read(2))[0] / 4096
                        vz1_12 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(2,1)
                        uvx1_12 = unpack("<h", f.read(2))[0] / 4096
                        uvy1_12 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(4,1)
                        vertices2m.append([vx1_12,vz1_12,vy1_12])
                    ...
                    if flagsC == 0x6E:
                        if facecount == 6:
                            ...
                            fa1aaam+=1*len(vertices2m)-16
                            fb1aaam+=1*len(vertices2m)-16
                            fc1aaam+=1*len(vertices2m)-16
                            fd1aaam+=1*len(vertices2m)-16
                            fe1aaam+=1*len(vertices2m)-16
                            ff1aaam+=1*len(vertices2m)-16
                            fg1aaam+=1*len(vertices2m)-16
                            fh1aaam+=1*len(vertices2m)-16
                            fi1aaam+=1*len(vertices2m)-16
                            fj1aaam+=1*len(vertices2m)-16
                            fk1aaam+=1*len(vertices2m)-16
                            fl1aaam+=1*len(vertices2m)-16
                            fm1aaam+=1*len(vertices2m)-16
                            fn1aaam+=1*len(vertices2m)-16
                            fo1aaam+=1*len(vertices2m)-16
                            fp1aaam+=1*len(vertices2m)-16
                            fq1aaam+=1*len(vertices2m)-16
                            fr1aaam+=1*len(vertices2m)-16
                            fs1aaam+=1*len(vertices2m)-16
                            ft1aaam+=1*len(vertices2m)-16
                            fu1aaam+=1*len(vertices2m)-16
                            ...
                            faces2m.append([fi1aaam,fj1aaam,fk1aaam])
                            faces2m.append([fj1aaam,fk1aaam,fl1aaam])
                            faces2m.append([fk1aaam,fl1aaam,fm1aaam])
                            faces2m.append([fm1aaam,fn1aaam,fo1aaam])
                            faces2m.append([fn1aaam,fo1aaam,fp1aaam])
                            faces2m.append([fo1aaam,fp1aaam,fq1aaam])
                            faces2m.append([fp1aaam,fq1aaam,fr1aaam])
                            faces2m.append([fq1aaam,fr1aaam,fs1aaam])
                            faces2m.append([fr1aaam,fs1aaam,ft1aaam])
                            faces2m.append([fs1aaam,ft1aaam,fu1aaam])

                        elif facecount == 5:
                            
                            id1 = unpack("B", f.read(1))[0]
                            fa1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fb1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fc1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fd1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fe1aaama = unpack("B", f.read(1))[0] & 0x2F
                            ff1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fg1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fh1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fi1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fj1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fk1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fl1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fm1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fn1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fo1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fp1aaama = unpack("B", f.read(1))[0] & 0x2F
                            fq1aaama = unpack("B", f.read(1))[0] & 0x2F
                            f.seek(2,1)
                            ...
                            fa1aaama+=1*len(vertices2m)-16
                            fb1aaama+=1*len(vertices2m)-16
                            fc1aaama+=1*len(vertices2m)-16
                            fd1aaama+=1*len(vertices2m)-16
                            fe1aaama+=1*len(vertices2m)-16
                            ff1aaama+=1*len(vertices2m)-16
                            fg1aaama+=1*len(vertices2m)-16
                            fh1aaama+=1*len(vertices2m)-16
                            fi1aaama+=1*len(vertices2m)-16
                            fj1aaama+=1*len(vertices2m)-16
                            fk1aaama+=1*len(vertices2m)-16
                            fl1aaama+=1*len(vertices2m)-16
                            fm1aaama+=1*len(vertices2m)-16
                            fn1aaama+=1*len(vertices2m)-16
                            fo1aaama+=1*len(vertices2m)-16
                            fp1aaama+=1*len(vertices2m)-16
                            fq1aaama+=1*len(vertices2m)-16
                            ...
                            faces2m.append([fi1aaama,fj1aaama,fk1aaama])
                            faces2m.append([fj1aaama,fk1aaama,fl1aaama])
                            faces2m.append([fk1aaama,fl1aaama,fm1aaama])
                            faces2m.append([fm1aaama,fn1aaama,fo1aaama])
                            faces2m.append([fn1aaama,fo1aaama,fp1aaama])
                            faces2m.append([fo1aaama,fp1aaama,fq1aaama])

                elif vertexCount == 17:
                    for i in range(vertexCount):
                        vx1_13 = unpack("<h", f.read(2))[0] / 4096
                        vy1_13 = unpack("<h", f.read(2))[0] / 4096
                        vz1_13 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(2,1)
                        uvx1_13 = unpack("<h", f.read(2))[0] / 4096
                        uvy1_13 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(4,1)
                        vertices2n.append([vx1_13,vz1_13,vy1_13])
                    ...
                    if flagsC == 0x6E:
                        if facecount == 7:
                            ...
                            fa1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaana = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaana = unpack("B", f.read(1))[0] & 0x3F
                            fs1aaana = unpack("B", f.read(1))[0] & 0x3F
                            ft1aaana = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaana+=1*len(vertices2n)-17
                            fb1aaana+=1*len(vertices2n)-17
                            fc1aaana+=1*len(vertices2n)-17
                            fd1aaana+=1*len(vertices2n)-17
                            fe1aaana+=1*len(vertices2n)-17
                            ff1aaana+=1*len(vertices2n)-17
                            fg1aaana+=1*len(vertices2n)-17
                            fh1aaana+=1*len(vertices2n)-17
                            fi1aaana+=1*len(vertices2n)-17
                            fj1aaana+=1*len(vertices2n)-17
                            fk1aaana+=1*len(vertices2n)-17
                            fl1aaana+=1*len(vertices2n)-17
                            fm1aaana+=1*len(vertices2n)-17
                            fn1aaana+=1*len(vertices2n)-17
                            fo1aaana+=1*len(vertices2n)-17
                            fp1aaana+=1*len(vertices2n)-17
                            fq1aaana+=1*len(vertices2n)-17
                            fr1aaana+=1*len(vertices2n)-17
                            fs1aaana+=1*len(vertices2n)-17
                            ft1aaana+=1*len(vertices2n)-17

                            faces2n.append([fa1aaana,fb1aaana,fc1aaana])
                            faces2n.append([fb1aaana,fc1aaana,fd1aaana])
                            faces2n.append([fc1aaana,fd1aaana,fe1aaana])
                            faces2n.append([fd1aaana,fe1aaana,ff1aaana])
                            faces2n.append([fg1aaana,fh1aaana,fi1aaana])
                            faces2n.append([fh1aaana,fi1aaana,fj1aaana])
                            faces2n.append([fi1aaana,fj1aaana,fk1aaana])
                            faces2n.append([fj1aaana,fk1aaana,fl1aaana])
                            faces2n.append([fk1aaana,fl1aaana,fm1aaana])
                            faces2n.append([fm1aaana,fn1aaana,fo1aaana])
                            faces2n.append([fn1aaana,fo1aaana,fp1aaana])
                            faces2n.append([fo1aaana,fp1aaana,fq1aaana])
                            faces2n.append([fp1aaana,fq1aaana,fr1aaana])
                            ...
                            fa1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaanb = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaanb+=1*len(vertices2n)-17
                            fb1aaanb+=1*len(vertices2n)-17
                            fc1aaanb+=1*len(vertices2n)-17
                            fd1aaanb+=1*len(vertices2n)-17
                            fe1aaanb+=1*len(vertices2n)-17
                            ff1aaanb+=1*len(vertices2n)-17
                            fg1aaanb+=1*len(vertices2n)-17
                            fh1aaanb+=1*len(vertices2n)-17
                            fi1aaanb+=1*len(vertices2n)-17
                            fj1aaanb+=1*len(vertices2n)-17
                            fk1aaanb+=1*len(vertices2n)-17
                            fl1aaanb+=1*len(vertices2n)-17
                            fm1aaanb+=1*len(vertices2n)-17
                            fn1aaanb+=1*len(vertices2n)-17
                            fo1aaanb+=1*len(vertices2n)-17

                            faces2n.append([fa1aaanb,fb1aaanb,fc1aaanb])
                            faces2n.append([fb1aaanb,fc1aaanb,fd1aaanb])
                            faces2n.append([fc1aaanb,fd1aaanb,fe1aaanb])
                            faces2n.append([fd1aaanb,fe1aaanb,ff1aaanb])
                            faces2n.append([fg1aaanb,fh1aaanb,fi1aaanb])
                            faces2n.append([fh1aaanb,fi1aaanb,fj1aaanb])
                            faces2n.append([fi1aaanb,fj1aaanb,fk1aaanb])
                            faces2n.append([fj1aaanb,fk1aaanb,fl1aaanb])
                            faces2n.append([fk1aaanb,fl1aaanb,fm1aaanb])
                            faces2n.append([fm1aaanb,fn1aaanb,fo1aaanb])

                elif vertexCount == 18:
                    for i in range(vertexCount):
                        vx1_14 = unpack("<h", f.read(2))[0] / 4096
                        vy1_14 = unpack("<h", f.read(2))[0] / 4096
                        vz1_14 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(2,1)
                        uvx1_14 = unpack("<h", f.read(2))[0] / 4096
                        uvy1_14 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(4,1)
                        vertices2o.append([vx1_14,vz1_14,vy1_14])
                    ...
                    if flagsC == 0x6E:
                        if facecount == 8:
                            ...
                            fa1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fs1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            ft1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fu1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fv1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fw1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            fx1aaaob = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaaob+=1*len(vertices2o)-18
                            fb1aaaob+=1*len(vertices2o)-18
                            fc1aaaob+=1*len(vertices2o)-18
                            fd1aaaob+=1*len(vertices2o)-18
                            fe1aaaob+=1*len(vertices2o)-18
                            ff1aaaob+=1*len(vertices2o)-18
                            fg1aaaob+=1*len(vertices2o)-18
                            fh1aaaob+=1*len(vertices2o)-18
                            fi1aaaob+=1*len(vertices2o)-18
                            fj1aaaob+=1*len(vertices2o)-18
                            fk1aaaob+=1*len(vertices2o)-18
                            fl1aaaob+=1*len(vertices2o)-18
                            fm1aaaob+=1*len(vertices2o)-18
                            fn1aaaob+=1*len(vertices2o)-18
                            fo1aaaob+=1*len(vertices2o)-18
                            fp1aaaob+=1*len(vertices2o)-18
                            fq1aaaob+=1*len(vertices2o)-18
                            fr1aaaob+=1*len(vertices2o)-18
                            fs1aaaob+=1*len(vertices2o)-18
                            ft1aaaob+=1*len(vertices2o)-18
                            fu1aaaob+=1*len(vertices2o)-18
                            fv1aaaob+=1*len(vertices2o)-18
                            fw1aaaob+=1*len(vertices2o)-18
                            fx1aaaob+=1*len(vertices2o)-18

                            faces2o.append([fa1aaaob,fb1aaaob,fc1aaaob])
                            faces2o.append([fb1aaaob,fc1aaaob,fd1aaaob])
                            faces2o.append([fc1aaaob,fd1aaaob,fe1aaaob])
                            faces2o.append([fd1aaaob,fe1aaaob,ff1aaaob])
                            faces2o.append([fg1aaaob,fh1aaaob,fi1aaaob])
                            faces2o.append([fh1aaaob,fi1aaaob,fj1aaaob])
                            faces2o.append([fi1aaaob,fj1aaaob,fk1aaaob])
                            faces2o.append([fj1aaaob,fk1aaaob,fl1aaaob])
                            faces2o.append([fk1aaaob,fl1aaaob,fm1aaaob])
                            faces2o.append([fm1aaaob,fn1aaaob,fo1aaaob])
                            faces2o.append([fn1aaaob,fo1aaaob,fp1aaaob])
                            faces2o.append([fo1aaaob,fp1aaaob,fq1aaaob])
                            faces2o.append([fp1aaaob,fq1aaaob,fr1aaaob])
                            faces2o.append([fq1aaaob,fr1aaaob,fs1aaaob])
                            faces2o.append([fr1aaaob,fs1aaaob,ft1aaaob])
                            faces2o.append([fs1aaaob,ft1aaaob,fu1aaaob])
                            faces2o.append([ft1aaaob,fu1aaaob,fv1aaaob])
                            faces2o.append([fu1aaaob,fv1aaaob,fw1aaaob])
                            faces2o.append([fv1aaaob,fw1aaaob,fx1aaaob])
                            
                        elif facecount == 7:
                            
                            id1 = unpack("B", f.read(1))[0]

                            fa1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaao = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fs1aaao = unpack("B", f.read(1))[0] & 0x3F
                            ft1aaao = unpack("B", f.read(1))[0] & 0x3F
                            fu1aaao = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaao+=1*len(vertices2o)-18
                            fb1aaao+=1*len(vertices2o)-18
                            fc1aaao+=1*len(vertices2o)-18
                            fd1aaao+=1*len(vertices2o)-18
                            fe1aaao+=1*len(vertices2o)-18
                            ff1aaao+=1*len(vertices2o)-18
                            fg1aaao+=1*len(vertices2o)-18
                            fh1aaao+=1*len(vertices2o)-18
                            fi1aaao+=1*len(vertices2o)-18
                            fj1aaao+=1*len(vertices2o)-18
                            fk1aaao+=1*len(vertices2o)-18
                            fl1aaao+=1*len(vertices2o)-18
                            fm1aaao+=1*len(vertices2o)-18
                            fn1aaao+=1*len(vertices2o)-18
                            fo1aaao+=1*len(vertices2o)-18
                            fp1aaao+=1*len(vertices2o)-18
                            fq1aaao+=1*len(vertices2o)-18
                            fr1aaao+=1*len(vertices2o)-18
                            fs1aaao+=1*len(vertices2o)-18
                            ft1aaao+=1*len(vertices2o)-18
                            fu1aaao+=1*len(vertices2o)-18

                            faces2o.append([fa1aaao,fb1aaao,fc1aaao])
                            faces2o.append([fb1aaao,fc1aaao,fd1aaao])
                            faces2o.append([fc1aaao,fd1aaao,fe1aaao])
                            faces2o.append([fd1aaao,fe1aaao,ff1aaao])
                            faces2o.append([fg1aaao,fh1aaao,fi1aaao])
                            faces2o.append([fh1aaao,fi1aaao,fj1aaao])
                            faces2o.append([fi1aaao,fj1aaao,fk1aaao])
                            faces2o.append([fj1aaao,fk1aaao,fl1aaao])
                            faces2o.append([fk1aaao,fl1aaao,fm1aaao])
                            faces2o.append([fm1aaao,fn1aaao,fo1aaao])
                            faces2o.append([fn1aaao,fo1aaao,fp1aaao])
                            faces2o.append([fo1aaao,fp1aaao,fq1aaao])
                            faces2o.append([fp1aaao,fq1aaao,fr1aaao])
                            faces2o.append([fq1aaao,fr1aaao,fs1aaao])
                            faces2o.append([fr1aaao,fs1aaao,ft1aaao])
                            faces2o.append([fs1aaao,ft1aaao,fu1aaao])

                        elif facecount == 6:
                            
                            id1 = unpack("B", f.read(1))[0]

                            fa1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaaoc = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaaoc+=1*len(vertices2o)-18
                            fb1aaaoc+=1*len(vertices2o)-18
                            fc1aaaoc+=1*len(vertices2o)-18
                            fd1aaaoc+=1*len(vertices2o)-18
                            fe1aaaoc+=1*len(vertices2o)-18
                            ff1aaaoc+=1*len(vertices2o)-18
                            fg1aaaoc+=1*len(vertices2o)-18
                            fh1aaaoc+=1*len(vertices2o)-18
                            fi1aaaoc+=1*len(vertices2o)-18
                            fj1aaaoc+=1*len(vertices2o)-18
                            fk1aaaoc+=1*len(vertices2o)-18
                            fl1aaaoc+=1*len(vertices2o)-18
                            fm1aaaoc+=1*len(vertices2o)-18
                            fn1aaaoc+=1*len(vertices2o)-18
                            fo1aaaoc+=1*len(vertices2o)-18
                            fp1aaaoc+=1*len(vertices2o)-18
                            fq1aaaoc+=1*len(vertices2o)-18
                            fr1aaaoc+=1*len(vertices2o)-18

                            faces2o.append([fa1aaaoc,fb1aaaoc,fc1aaaoc])
                            faces2o.append([fb1aaaoc,fc1aaaoc,fd1aaaoc])
                            faces2o.append([fc1aaaoc,fd1aaaoc,fe1aaaoc])
                            faces2o.append([fd1aaaoc,fe1aaaoc,ff1aaaoc])
                            faces2o.append([fg1aaaoc,fh1aaaoc,fi1aaaoc])
                            faces2o.append([fh1aaaoc,fi1aaaoc,fj1aaaoc])
                            faces2o.append([fi1aaaoc,fj1aaaoc,fk1aaaoc])
                            faces2o.append([fj1aaaoc,fk1aaaoc,fl1aaaoc])
                            faces2o.append([fk1aaaoc,fl1aaaoc,fm1aaaoc])
                            faces2o.append([fm1aaaoc,fn1aaaoc,fo1aaaoc])
                            faces2o.append([fn1aaaoc,fo1aaaoc,fp1aaaoc])
                            faces2o.append([fo1aaaoc,fp1aaaoc,fq1aaaoc])
                            faces2o.append([fp1aaaoc,fq1aaaoc,fr1aaaoc])
                            
                        elif facecount == 5:
                            
                            id1 = unpack("B", f.read(1))[0]

                            fa1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaaoa = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaaoa+=1*len(vertices2o)-18
                            fb1aaaoa+=1*len(vertices2o)-18
                            fc1aaaoa+=1*len(vertices2o)-18
                            fd1aaaoa+=1*len(vertices2o)-18
                            fe1aaaoa+=1*len(vertices2o)-18
                            ff1aaaoa+=1*len(vertices2o)-18
                            fg1aaaoa+=1*len(vertices2o)-18
                            fh1aaaoa+=1*len(vertices2o)-18
                            fi1aaaoa+=1*len(vertices2o)-18
                            fj1aaaoa+=1*len(vertices2o)-18
                            fk1aaaoa+=1*len(vertices2o)-18
                            fl1aaaoa+=1*len(vertices2o)-18
                            fm1aaaoa+=1*len(vertices2o)-18
                            fn1aaaoa+=1*len(vertices2o)-18
                            fo1aaaoa+=1*len(vertices2o)-18

                            faces2o.append([fa1aaaoa,fb1aaaoa,fc1aaaoa])
                            faces2o.append([fb1aaaoa,fc1aaaoa,fd1aaaoa])
                            faces2o.append([fc1aaaoa,fd1aaaoa,fe1aaaoa])
                            faces2o.append([fd1aaaoa,fe1aaaoa,ff1aaaoa])
                            faces2o.append([fg1aaaoa,fh1aaaoa,fi1aaaoa])
                            faces2o.append([fh1aaaoa,fi1aaaoa,fj1aaaoa])
                            faces2o.append([fi1aaaoa,fj1aaaoa,fk1aaaoa])
                            faces2o.append([fj1aaaoa,fk1aaaoa,fl1aaaoa])
                            faces2o.append([fk1aaaoa,fl1aaaoa,fm1aaaoa])
                            faces2o.append([fm1aaaoa,fn1aaaoa,fo1aaaoa])

                elif vertexCount == 19:
                    for i in range(vertexCount):
                        vx1_15 = unpack("<h", f.read(2))[0] / 4096
                        vy1_15 = unpack("<h", f.read(2))[0] / 4096
                        vz1_15 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(2,1)
                        uvx1_15 = unpack("<h", f.read(2))[0] / 4096
                        uvy1_15 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(4,1)
                        vertices2p.append([vx1_15,vz1_15,vy1_15])
                    ...
                    if flagsC == 0x6E:
                        if facecount == 7:
                            ...
                            fa1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaap = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fs1aaap = unpack("B", f.read(1))[0] & 0x3F
                            ft1aaap = unpack("B", f.read(1))[0] & 0x3F
                            fu1aaap = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaap+=1*len(vertices2p)-19
                            fb1aaap+=1*len(vertices2p)-19
                            fc1aaap+=1*len(vertices2p)-19
                            fd1aaap+=1*len(vertices2p)-19
                            fe1aaap+=1*len(vertices2p)-19
                            ff1aaap+=1*len(vertices2p)-19
                            fg1aaap+=1*len(vertices2p)-19
                            fh1aaap+=1*len(vertices2p)-19
                            fi1aaap+=1*len(vertices2p)-19
                            fj1aaap+=1*len(vertices2p)-19
                            fk1aaap+=1*len(vertices2p)-19
                            fl1aaap+=1*len(vertices2p)-19
                            fm1aaap+=1*len(vertices2p)-19
                            fn1aaap+=1*len(vertices2p)-19
                            fo1aaap+=1*len(vertices2p)-19
                            fp1aaap+=1*len(vertices2p)-19
                            fq1aaap+=1*len(vertices2p)-19
                            fr1aaap+=1*len(vertices2p)-19
                            fs1aaap+=1*len(vertices2p)-19
                            ft1aaap+=1*len(vertices2p)-19
                            fu1aaap+=1*len(vertices2p)-19

                            faces2p.append([fa1aaap,fb1aaap,fc1aaap])
                            faces2p.append([fb1aaap,fc1aaap,fd1aaap])
                            faces2p.append([fc1aaap,fd1aaap,fe1aaap])
                            faces2p.append([fd1aaap,fe1aaap,ff1aaap])
                            faces2p.append([fg1aaap,fh1aaap,fi1aaap])
                            faces2p.append([fh1aaap,fi1aaap,fj1aaap])
                            faces2p.append([fi1aaap,fj1aaap,fk1aaap])
                            faces2p.append([fj1aaap,fk1aaap,fl1aaap])
                            faces2p.append([fk1aaap,fl1aaap,fm1aaap])
                            faces2p.append([fm1aaap,fn1aaap,fo1aaap])
                            faces2p.append([fn1aaap,fo1aaap,fp1aaap])
                            faces2p.append([fo1aaap,fp1aaap,fq1aaap])
                            faces2p.append([fp1aaap,fq1aaap,fr1aaap])
                            faces2p.append([fq1aaap,fr1aaap,fs1aaap])
                            ...
                            fa1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaapb = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaapb+=1*len(vertices2p)-19
                            fb1aaapb+=1*len(vertices2p)-19
                            fc1aaapb+=1*len(vertices2p)-19
                            fd1aaapb+=1*len(vertices2p)-19
                            fe1aaapb+=1*len(vertices2p)-19
                            ff1aaapb+=1*len(vertices2p)-19
                            fg1aaapb+=1*len(vertices2p)-19
                            fh1aaapb+=1*len(vertices2p)-19
                            fi1aaapb+=1*len(vertices2p)-19
                            fj1aaapb+=1*len(vertices2p)-19
                            fk1aaapb+=1*len(vertices2p)-19
                            fl1aaapb+=1*len(vertices2p)-19
                            fm1aaapb+=1*len(vertices2p)-19
                            fn1aaapb+=1*len(vertices2p)-19
                            fo1aaapb+=1*len(vertices2p)-19

                            faces2p.append([fa1aaapb,fb1aaapb,fc1aaapb])
                            faces2p.append([fb1aaapb,fc1aaapb,fd1aaapb])
                            faces2p.append([fc1aaapb,fd1aaapb,fe1aaapb])
                            faces2p.append([fd1aaapb,fe1aaapb,ff1aaapb])
                            faces2p.append([fg1aaapb,fh1aaapb,fi1aaapb])
                            faces2p.append([fh1aaapb,fi1aaapb,fj1aaapb])
                            faces2p.append([fi1aaapb,fj1aaapb,fk1aaapb])
                            faces2p.append([fj1aaapb,fk1aaapb,fl1aaapb])
                            faces2p.append([fk1aaapb,fl1aaapb,fm1aaapb])
                            faces2p.append([fm1aaapb,fn1aaapb,fo1aaapb])

                elif vertexCount == 20:
                    for i in range(vertexCount):
                        vx1_16 = unpack("<h", f.read(2))[0] / 4096
                        vy1_16 = unpack("<h", f.read(2))[0] / 4096
                        vz1_16 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(2,1)
                        uvx1_16 = unpack("<h", f.read(2))[0] / 4096
                        uvy1_16 = unpack("<h", f.read(2))[0] / 4096
                        f.seek(4,1)
                        vertices2q.append([vx1_16,vz1_16,vy1_16])
                    f.seek(146,1)
                    facecount = unpack("B", f.read(1))[0]
                    flagsC = unpack("B", f.read(1))[0]
                    if flagsC == 0x6E:
                        if facecount == 9:
                            ...
                            fa1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fs1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            ft1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fu1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fv1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fw1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fx1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fy1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fz1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            fzz1aaaqb = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaaqb+=1*len(vertices2q)-20
                            fb1aaaqb+=1*len(vertices2q)-20
                            fc1aaaqb+=1*len(vertices2q)-20
                            fd1aaaqb+=1*len(vertices2q)-20
                            fe1aaaqb+=1*len(vertices2q)-20
                            ff1aaaqb+=1*len(vertices2q)-20
                            fg1aaaqb+=1*len(vertices2q)-20
                            fh1aaaqb+=1*len(vertices2q)-20
                            fi1aaaqb+=1*len(vertices2q)-20
                            fj1aaaqb+=1*len(vertices2q)-20
                            fk1aaaqb+=1*len(vertices2q)-20
                            fl1aaaqb+=1*len(vertices2q)-20
                            fm1aaaqb+=1*len(vertices2q)-20
                            fn1aaaqb+=1*len(vertices2q)-20
                            fo1aaaqb+=1*len(vertices2q)-20
                            fp1aaaqb+=1*len(vertices2q)-20
                            fq1aaaqb+=1*len(vertices2q)-20
                            fr1aaaqb+=1*len(vertices2q)-20
                            fs1aaaqb+=1*len(vertices2q)-20
                            ft1aaaqb+=1*len(vertices2q)-20
                            fu1aaaqb+=1*len(vertices2q)-20
                            fv1aaaqb+=1*len(vertices2q)-20
                            fw1aaaqb+=1*len(vertices2q)-20
                            fx1aaaqb+=1*len(vertices2q)-20
                            fy1aaaqb+=1*len(vertices2q)-20
                            fz1aaaqb+=1*len(vertices2q)-20
                            fzz1aaaqb+=1*len(vertices2q)-20

                            faces2q.append([fa1aaaqb,fb1aaaqb,fc1aaaqb])
                            faces2q.append([fb1aaaqb,fc1aaaqb,fd1aaaqb])
                            faces2q.append([fc1aaaqb,fd1aaaqb,fe1aaaqb])
                            faces2q.append([fd1aaaqb,fe1aaaqb,ff1aaaqb])
                            faces2q.append([fg1aaaqb,fh1aaaqb,fi1aaaqb])
                            faces2q.append([fh1aaaqb,fi1aaaqb,fj1aaaqb])
                            faces2q.append([fi1aaaqb,fj1aaaqb,fk1aaaqb])
                            faces2q.append([fj1aaaqb,fk1aaaqb,fl1aaaqb])
                            faces2q.append([fk1aaaqb,fl1aaaqb,fm1aaaqb])
                            faces2q.append([fl1aaaqb,fm1aaaqb,fn1aaaqb])
                            faces2q.append([fm1aaaqb,fn1aaaqb,fo1aaaqb])
                            faces2q.append([fn1aaaqb,fo1aaaqb,fp1aaaqb])
                            faces2q.append([fo1aaaqb,fp1aaaqb,fq1aaaqb])
                            faces2q.append([fp1aaaqb,fq1aaaqb,fr1aaaqb])
                            faces2q.append([fq1aaaqb,fr1aaaqb,fs1aaaqb])
                            faces2q.append([fr1aaaqb,fs1aaaqb,ft1aaaqb])
                            faces2q.append([fs1aaaqb,ft1aaaqb,fu1aaaqb])
                            faces2q.append([ft1aaaqb,fu1aaaqb,fv1aaaqb])
                            faces2q.append([fu1aaaqb,fv1aaaqb,fw1aaaqb])
                            faces2q.append([fv1aaaqb,fw1aaaqb,fx1aaaqb])
                            faces2q.append([fw1aaaqb,fx1aaaqb,fy1aaaqb])
                            faces2q.append([fx1aaaqb,fy1aaaqb,fz1aaaqb])
                            faces2q.append([fy1aaaqb,fz1aaaqb,fzz1aaaqb])
                        elif facecount == 7:
                            
                            id1 = unpack("B", f.read(1))[0]

                            fa1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fs1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            ft1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            fu1aaaqa = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaaqa+=1*len(vertices2q)-20
                            fb1aaaqa+=1*len(vertices2q)-20
                            fc1aaaqa+=1*len(vertices2q)-20
                            fd1aaaqa+=1*len(vertices2q)-20
                            fe1aaaqa+=1*len(vertices2q)-20
                            ff1aaaqa+=1*len(vertices2q)-20
                            fg1aaaqa+=1*len(vertices2q)-20
                            fh1aaaqa+=1*len(vertices2q)-20
                            fi1aaaqa+=1*len(vertices2q)-20
                            fj1aaaqa+=1*len(vertices2q)-20
                            fk1aaaqa+=1*len(vertices2q)-20
                            fl1aaaqa+=1*len(vertices2q)-20
                            fm1aaaqa+=1*len(vertices2q)-20
                            fn1aaaqa+=1*len(vertices2q)-20
                            fo1aaaqa+=1*len(vertices2q)-20
                            fp1aaaqa+=1*len(vertices2q)-20
                            fq1aaaqa+=1*len(vertices2q)-20
                            fr1aaaqa+=1*len(vertices2q)-20
                            fs1aaaqa+=1*len(vertices2q)-20
                            ft1aaaqa+=1*len(vertices2q)-20
                            fu1aaaqa+=1*len(vertices2q)-20

                            faces2q.append([fa1aaaqa,fb1aaaqa,fc1aaaqa])
                            faces2q.append([fb1aaaqa,fc1aaaqa,fd1aaaqa])
                            faces2q.append([fc1aaaqa,fd1aaaqa,fe1aaaqa])
                            faces2q.append([fd1aaaqa,fe1aaaqa,ff1aaaqa])
                            faces2q.append([fg1aaaqa,fh1aaaqa,fi1aaaqa])
                            faces2q.append([fh1aaaqa,fi1aaaqa,fj1aaaqa])
                            faces2q.append([fi1aaaqa,fj1aaaqa,fk1aaaqa])
                            faces2q.append([fj1aaaqa,fk1aaaqa,fl1aaaqa])
                            faces2q.append([fk1aaaqa,fl1aaaqa,fm1aaaqa])
                            faces2q.append([fl1aaaqa,fm1aaaqa,fn1aaaqa])
                            faces2q.append([fm1aaaqa,fn1aaaqa,fo1aaaqa])
                            faces2q.append([fn1aaaqa,fo1aaaqa,fp1aaaqa])
                            faces2q.append([fo1aaaqa,fp1aaaqa,fq1aaaqa])
                            faces2q.append([fp1aaaqa,fq1aaaqa,fr1aaaqa])
                            faces2q.append([fq1aaaqa,fr1aaaqa,fs1aaaqa])
                            faces2q.append([fr1aaaqa,fs1aaaqa,ft1aaaqa])
                            faces2q.append([fs1aaaqa,ft1aaaqa,fu1aaaqa])
                        elif facecount == 6:
                            
                            id1 = unpack("B", f.read(1))[0]

                            fa1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaaq = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaaq+=1*len(vertices2q)-20
                            fb1aaaq+=1*len(vertices2q)-20
                            fc1aaaq+=1*len(vertices2q)-20
                            fd1aaaq+=1*len(vertices2q)-20
                            fe1aaaq+=1*len(vertices2q)-20
                            ff1aaaq+=1*len(vertices2q)-20
                            fg1aaaq+=1*len(vertices2q)-20
                            fh1aaaq+=1*len(vertices2q)-20
                            fi1aaaq+=1*len(vertices2q)-20
                            fj1aaaq+=1*len(vertices2q)-20
                            fk1aaaq+=1*len(vertices2q)-20
                            fl1aaaq+=1*len(vertices2q)-20
                            fm1aaaq+=1*len(vertices2q)-20
                            fn1aaaq+=1*len(vertices2q)-20
                            fo1aaaq+=1*len(vertices2q)-20
                            fp1aaaq+=1*len(vertices2q)-20
                            fq1aaaq+=1*len(vertices2q)-20
                            fr1aaaq+=1*len(vertices2q)-20

                            faces2q.append([fa1aaaq,fb1aaaq,fc1aaaq])
                            faces2q.append([fb1aaaq,fc1aaaq,fd1aaaq])
                            faces2q.append([fc1aaaq,fd1aaaq,fe1aaaq])
                            faces2q.append([fd1aaaq,fe1aaaq,ff1aaaq])
                            faces2q.append([fg1aaaq,fh1aaaq,fi1aaaq])
                            faces2q.append([fh1aaaq,fi1aaaq,fj1aaaq])
                            faces2q.append([fi1aaaq,fj1aaaq,fk1aaaq])
                            faces2q.append([fj1aaaq,fk1aaaq,fl1aaaq])
                            faces2q.append([fk1aaaq,fl1aaaq,fm1aaaq])
                            faces2q.append([fl1aaaq,fm1aaaq,fn1aaaq])
                            faces2q.append([fm1aaaq,fn1aaaq,fo1aaaq])
                            faces2q.append([fn1aaaq,fo1aaaq,fp1aaaq])
                    ...
                    if flagsC == 0x6E:
                        if facecount == 6:
                            ...
                            fa1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaarc = unpack("B", f.read(1))[0] & 0x3F
                            ...
                            fa1aaarc+=1*len(vertices2r)-21
                            fb1aaarc+=1*len(vertices2r)-21
                            fc1aaarc+=1*len(vertices2r)-21
                            fd1aaarc+=1*len(vertices2r)-21
                            fe1aaarc+=1*len(vertices2r)-21
                            ff1aaarc+=1*len(vertices2r)-21
                            fg1aaarc+=1*len(vertices2r)-21
                            fh1aaarc+=1*len(vertices2r)-21
                            fi1aaarc+=1*len(vertices2r)-21
                            fj1aaarc+=1*len(vertices2r)-21
                            fk1aaarc+=1*len(vertices2r)-21
                            fl1aaarc+=1*len(vertices2r)-21
                            fm1aaarc+=1*len(vertices2r)-21
                            fn1aaarc+=1*len(vertices2r)-21
                            fo1aaarc+=1*len(vertices2r)-21
                            fp1aaarc+=1*len(vertices2r)-21
                            fq1aaarc+=1*len(vertices2r)-21
                            fr1aaarc+=1*len(vertices2r)-21

                            faces2r.append([fa1aaarc,fb1aaarc,fc1aaarc])
                            faces2r.append([fb1aaarc,fc1aaarc,fd1aaarc])
                            faces2r.append([fc1aaarc,fd1aaarc,fe1aaarc])
                            faces2r.append([fd1aaarc,fe1aaarc,ff1aaarc])
                            faces2r.append([fg1aaarc,fh1aaarc,fi1aaarc])
                            faces2r.append([fh1aaarc,fi1aaarc,fj1aaarc])
                            faces2r.append([fi1aaarc,fj1aaarc,fk1aaarc])
                            faces2r.append([fj1aaarc,fk1aaarc,fl1aaarc])
                            faces2r.append([fk1aaarc,fl1aaarc,fm1aaarc])
                            faces2r.append([fl1aaarc,fm1aaarc,fn1aaarc])
                            faces2r.append([fm1aaarc,fn1aaarc,fo1aaarc])
                            faces2r.append([fn1aaarc,fo1aaarc,fp1aaarc])
                            faces2r.append([fo1aaarc,fp1aaarc,fq1aaarc])
                            faces2r.append([fp1aaarc,fq1aaarc,fr1aaarc])
                        elif facecount == 8:
                            id1 = unpack("B", f.read(1))[0]

                            fa1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fb1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fc1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fd1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fe1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            ff1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fg1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fh1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fi1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fj1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fk1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fl1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fm1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fn1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fo1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fp1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fq1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fr1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fs1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            ft1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fu1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fv1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fw1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            fx1aaarb = unpack("B", f.read(1))[0] & 0x3F
                            f.seek(7,1)
                            ...
                            fa1aaarb+=1*len(vertices2r)-21
                            fb1aaarb+=1*len(vertices2r)-21
                            fc1aaarb+=1*len(vertices2r)-21
                            fd1aaarb+=1*len(vertices2r)-21
                            fe1aaarb+=1*len(vertices2r)-21
                            ff1aaarb+=1*len(vertices2r)-21
                            fg1aaarb+=1*len(vertices2r)-21
                            fh1aaarb+=1*len(vertices2r)-21
                            fi1aaarb+=1*len(vertices2r)-21
                            fj1aaarb+=1*len(vertices2r)-21
                            fk1aaarb+=1*len(vertices2r)-21
                            fl1aaarb+=1*len(vertices2r)-21
                            fm1aaarb+=1*len(vertices2r)-21
                            fn1aaarb+=1*len(vertices2r)-21
                            fo1aaarb+=1*len(vertices2r)-21
                            fp1aaarb+=1*len(vertices2r)-21
                            fq1aaarb+=1*len(vertices2r)-21
                            fr1aaarb+=1*len(vertices2r)-21
                            fs1aaarb+=1*len(vertices2r)-21
                            ft1aaarb+=1*len(vertices2r)-21
                            fu1aaarb+=1*len(vertices2r)-21
                            fv1aaarb+=1*len(vertices2r)-21
                            fw1aaarb+=1*len(vertices2r)-21
                            fx1aaarb+=1*len(vertices2r)-21

                            faces2r.append([fa1aaarb,fb1aaarb,fc1aaarb])
                            faces2r.append([fb1aaarb,fc1aaarb,fd1aaarb])
                            faces2r.append([fc1aaarb,fd1aaarb,fe1aaarb])
                            faces2r.append([fd1aaarb,fe1aaarb,ff1aaarb])
                            faces2r.append([fg1aaarb,fh1aaarb,fi1aaarb])
                            faces2r.append([fh1aaarb,fi1aaarb,fj1aaarb])
                            faces2r.append([fi1aaarb,fj1aaarb,fk1aaarb])
                            faces2r.append([fj1aaarb,fk1aaarb,fl1aaarb])
                            faces2r.append([fk1aaarb,fl1aaarb,fm1aaarb])
                            faces2r.append([fl1aaarb,fm1aaarb,fn1aaarb])
                            faces2r.append([fm1aaarb,fn1aaarb,fo1aaarb])
                            faces2r.append([fn1aaarb,fo1aaarb,fp1aaarb])
                            faces2r.append([fo1aaarb,fp1aaarb,fq1aaarb])
                            faces2r.append([fp1aaarb,fq1aaarb,fr1aaarb])
                            faces2r.append([fq1aaarb,fr1aaarb,fs1aaarb])
                            faces2r.append([fr1aaarb,fs1aaarb,ft1aaarb])
                            faces2r.append([fs1aaarb,ft1aaarb,fu1aaarb])
                            faces2r.append([ft1aaarb,fu1aaarb,fv1aaarb])
                            faces2r.append([fu1aaarb,fv1aaarb,fw1aaarb])
                            faces2r.append([fv1aaarb,fw1aaarb,fx1aaarb])
            ...
            if flag2 == 0x6C:
                if vertexCount == 0:
                    ...
                    for j in range(1):
                        ...
                        f.seek(3,1)
                        vertices3Caq.append([vx0001__AA,vz0001__AA,vy0001__AA])
                        vertices3Caq.append([vx0001__AB,vz0001__AB,vy0001__AB])
                        vertices3Caq.append([vx0001__AC,vz0001__AC,vy0001__AC])
                        uvs3Caq.append([uvx0001__AA,-uvy0001__AA])
                        uvs3Caq.append([uvx0001__AB,-uvy0001__AB])
                        uvs3Caq.append([uvx0001__AC,-uvy0001__AC])
                    for i in range(vertexCount-3):
                        fa2CAQ+=1*3
                        fb2CAQ+=1*3
                        fc2CAQ+=1*3
                    ...
                    for j in range(1):
                        ...
                        uvs3Daq.append([uvx0001__AA_,-uvy0001__AA_])
                        uvs3Daq.append([uvx0001__AB_,-uvy0001__AB_])
                        uvs3Daq.append([uvx0001__AC_,-uvy0001__AC_])
                    for i in range(vertexCount-3):
                        fa3CAQ+=1*3
                        fb3CAQ+=1*3
                        fc3CAQ+=1*3
                        faces3Daq.append([fa3CAQ,fb3CAQ,fc3CAQ])
    ...
    uv_tex3yyD = mesh3yyD.uv_layers.new()
    uv_layer3yyD = mesh3yyD.uv_layers[0].data
    vert_loops3yyD = {}
    for l in mesh3yyD.loops:
        vert_loops3yyD.setdefault(l.vertex_index, []).append(l.index)
    for i, coord in enumerate(uvs3Caq):
        for li in vert_loops3yyD[i]:
            uv_layer3yyD[li].uv = coord
